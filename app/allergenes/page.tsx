...
export default function AllergenesPage() {
  return (
    <>
      ...
      <Footer dict={{
        nav: { home: 'Accueil', menus: 'Menus', photos: 'Photos', contact: 'Contact', allergenes: 'Allergènes' },
        findUs: { address: "Avenue de l'Exposition 266, 1090 Jette", phone: '02 478 88 80', websiteLabel: "Site officiel: perledasie.be", websiteUrl: "https://www.perledasie.be/" },
